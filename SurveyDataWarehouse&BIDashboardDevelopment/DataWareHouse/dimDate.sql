...
--CREATE TABLE [dbo].[DimDate_sh](
--	[numberdate] [int] NOT NULL,
...
Declare @date datetime = '2030/01/01'--'1921/03/21'
Declare 
    @numberdate INT,
	@DateKey int, 
...
While @date < '2070-01-01'
BEGIN
    SET @numberdate=GL_DW.[dbo].[GregorianDateForDB2](dbo.G2J (@date))
	...
	Values (@numberdate,@DateKey, @FullDateAlternateKey, @CalendarYear, @MonthNumberOfYear, @MonthName, @DayOfWeek, @DayOfWeekName, @CalendarSeason, @SeasonName,
